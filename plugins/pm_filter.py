...
async def next_page(bot, query):
    ...
    if int(req) not in [query.from_user.id, 0]:
        return await query.answer("DO YOUR OWN REQUEST & CLICK BRO", show_alert=True)
    try:
        offset = int(offset)
    except:
        offset = 0
...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        return await query.answer('Problem')
        ...
        return await query.answer('Going 🚶‍♂️')
        ...
        if groupids is None:
            ...
            return await query.answer('check channel id')
        buttons = []
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('𝘾𝙊𝙉𝙉𝙀𝘾𝙏𝙄𝙊𝙉', callback_data='coct'),
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⏹️ 𝘽𝙐𝙏𝙏𝙊𝙉𝙎', callback_data='button')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('👩‍🦯 𝘽𝘼𝘾𝙆', callback_data='help'),
            InlineKeyboardButton('👮‍♂️ 𝘼𝘿𝙈𝙄𝙉', callback_data='admin')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('👩‍🦯 𝘽𝘼𝘾𝙆', callback_data='help'),
            InlineKeyboardButton('♻️ 𝙍𝙀𝙁𝙍𝙀𝙎𝙃', callback_data='rfrsh')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb and imdb.get('poster'):
        try:
            ...
            feck = await message.reply_photo(photo=poster, caption=cap[:1024]+f"\n\n`⚡ This Request will be deleted in {round(FILTER_DELETE_TIMER/60)} Minutes ⚡.", reply_markup=InlineKeyboardMarkup(btn))
            await asyncio.sleep(FILTER_DELETE_TIMER)
            await feck.delete()
        except Exception as e:
            logger.exception(e)
